        ...
        <v-card-text class="pa-5">
          ...
          <v-row>
            <v-col cols="12" lg="4" md="6">
              <v-text-field density="compact" v-model="search" label="Search Products" hide-details
                  ...
                  <v-card-text>
                    <v-container>
                      <v-form ref="form">
                        <v-row>
                          <v-col cols="12" sm="6">
                            <v-text-field variant="outlined" hide-details label="Id"></v-text-field>
                          </v-col>
                          <v-col cols="12" sm="6">
          ...
          <v-table class="mt-5">
            ...
            <tbody>
              <tr v-for="product in products?.data" :key="product.id">
                ...
                <td>
                  <div class="d-flex align-center py-4">
                    <div v-if="product.attributes.image.data">
                      <v-img :src="`http://localhost:1337${product.attributes.image.data[0].attributes.url}`"
                        class="rounded-circle img-fluid" width="100px"></v-img>
                    </div>
                    <div v-else>
                      <v-img src="/images/products/4.jpg" width="100px" class="rounded-circle img-fluid"></v-img>
                    </div>
                ...
                <td>
                  <v-icon small class="mr-2 text-info cursor-pointer" title="Edit">mdi-pencil</v-icon>
                  <v-icon small class="text-error cursor-pointer" title="Delete">mdi-delete</v-icon>
                </td>
              </tr>
            </tbody>
