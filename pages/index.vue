...
const token = useCookie('token', {
    maxAge: 60 * 15,// 1  ชม.
    //expires: new Date(Date.now() + 60 * 60 * 24 * 7), // 1 สัปดาห์
})
    ...
    <VContainer fluid class="fill-height pa-0">
        <VRow no-gutters align="center" justify="center" class="fill-height">
            <VCol class="hidden-sm-and-down fill-height" md="6" lg="6">
                <VImg src="https://wallpaper.dog/large/17070069.png" cover
                    class="h-100 rounded-xl rounded-ts-0 rounded-bs-0 d-flex align-center justify-center">
                    <div class="text-center w-50 text-orange mx-auto">
                        <h1 class="mb-4">ยินดีต้อนรับการ กลับมาของคุณ</h1>
                        <p>
                ...
                <VRow no-gutters align="center" justify="center">
                    <VCol cols="12" md="6" class="pa-3">
                        ...
                        <VForm @submit.prevent="submit" class="mt-7">
                            ...
                            <div class="mt-5">
                                <VBtn type="submit" block min-height="44" class="gradient primary">เข้าสู่ระบบ</VBtn>
                            </div>
                        </VForm>
