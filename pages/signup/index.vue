                    ...
                    <VCol cols="12" md="6" class="pa-3">
                        ...
                        <VForm @submit.prevent="submit" class="mt-7">
                            <div>
                                ...
                                <VTextField v-model="name" :rules="[ruleRequired]"
                                    prepend-inner-icon="fluent:person-24-regular" id="name" name="name" />
                            </div>
                            <div class="mt-1">
                                <label class="label text-grey-darken-2" for="email">Email</label>
                                <VTextField v-model="email" :rules="[ruleRequired, ruleEmail]" type="email"
                            ...
                            <div class="mt-1">
                                ...
                                <VTextField v-model="password" :rules="[ruleRequired, rulePassLen]" type="password"
